    ...
    return (
        <div className="max-w-[1300px] mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mx-5">
                <div className="border border-[#CED4DA] px-11 py-10 rounded-lg">
                    ...
                    <p className=" mb-8">Find a teacher, coach, or expert for your hobby interest in your locality.  Find a partner, teammate, accompanist or collaborator.</p>
                    <button className="px-7 py-2 border-[#8064A2] border rounded-lg font-semibold text-[#8064A2] hover:bg-[#8064A2] hover:text-white">Connect</button>
                </div>
                <div className="border border-[#CED4DA] px-11 py-10 rounded-lg">
                    <div className="mb-6 flex items-center gap-6 ">
                    ...
                    <p className=" mb-8">Find a teacher, coach, or expert for your hobby interest in your locality.  Find a partner, teammate, accompanist or collaborator.</p>
                    <button className="px-7 py-2 border-[#8064A2] border rounded-lg font-semibold text-[#8064A2] hover:bg-[#8064A2] hover:text-white">Meet up</button>
                </div>
                <div className="border border-[#CED4DA] px-11 py-10 rounded-lg">
                    <div className="mb-6 flex items-center gap-6 ">
                    ...
                    <p className=" mb-8">Find equipment or supplies required for your hobby.  Buy, rent or borrow from shops, online stores or from community members.</p>
                    <button className="px-7 py-2 border-[#8064A2] border rounded-lg font-semibold text-[#8064A2] hover:bg-[#8064A2] hover:text-white">Get it</button>
                </div>
                <div className="border border-[#CED4DA] px-11 py-10 rounded-lg">
                    <div className="mb-6 flex items-center gap-6 ">
                    ...
                    <p className=" mb-8">Find events, meetups and workshops related to your hobby.  Register or buy tickets online.</p>
                    <button className="px-7 py-2 border-[#8064A2] border rounded-lg font-semibold text-[#8064A2] hover:bg-[#8064A2] hover:text-white">Attend</button>
                </div>
            </div>
        </div>
    );
