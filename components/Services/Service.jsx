            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mx-5">
                <div className="border border-[#CED4DA] px-6 lg:px-11 py-10 rounded-lg">
                    <div className="mb-6 flex justify-center lg:justify-start items-center gap-2 lg:gap-6 ">
                        ...
                        <span className="font-semibold text-2xl">People</span>
                    </div>
                    <p className="mb-8 text-center lg:text-start">Find a teacher, coach, or expert for your hobby interest in your locality.  Find a partner, teammate, accompanist or collaborator.</p>
                    <button className="px-7 py-2 border-[#8064A2] border rounded-lg font-semibold text-[#8064A2] hover:bg-[#8064A2] hover:text-white flex mx-auto lg:inline-block">Connect</button>
                </div>
                <div className="border border-[#CED4DA] px-6 lg:px-11 py-10 rounded-lg">
                    <div className="mb-6 flex justify-center lg:justify-start items-center gap-2 lg:gap-6 ">
                        <svg width="40" height="34" viewBox="0 0 24 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className=" mb-8 text-center lg:text-start">Find a teacher, coach, or expert for your hobby interest in your locality.  Find a partner, teammate, accompanist or collaborator.</p>
                    <button className="px-7 py-2 border-[#8064A2] border rounded-lg font-semibold text-[#8064A2] hover:bg-[#8064A2] hover:text-white flex mx-auto lg:inline-block">Meet up</button>
                </div>
                <div className="border border-[#CED4DA] px-6 lg:px-11 py-10 rounded-lg">
                    <div className="mb-6 flex justify-center lg:justify-start items-center gap-2 lg:gap-6 ">
                    ...
                    <p className=" mb-8 text-center lg:text-start">Find equipment or supplies required for your hobby.  Buy, rent or borrow from shops, online stores or from community members.</p>
                    <button className="px-7 py-2 border-[#8064A2] border rounded-lg font-semibold text-[#8064A2] hover:bg-[#8064A2] hover:text-white flex mx-auto lg:inline-block">Get it</button>
                </div>
                <div className="border border-[#CED4DA] px-6 lg:px-11 py-10 rounded-lg">
                    <div className="mb-6 flex justify-center lg:justify-start items-center gap-2 lg:gap-6 ">
                        ...
                        <span className="font-semibold text-2xl">Program</span>
                    </div>
                    <p className=" mb-8 text-center lg:text-start">Find events, meetups and workshops related to your hobby.  Register or buy tickets online.</p>
                    <button className="px-7 py-2 border-[#8064A2] border rounded-lg font-semibold text-[#8064A2] hover:bg-[#8064A2] hover:text-white flex mx-auto lg:inline-block">Attend</button>
                </div>
            </div>
        </div>
    );
